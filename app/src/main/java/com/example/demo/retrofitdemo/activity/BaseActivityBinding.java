 ...
 */
public abstract class BaseActivityBinding<T extends ViewDataBinding> extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, defineLayoutResource());
