package com.example.demo.retrofitdemo.util;
...
public class Preference {
    ...
    private Preference() {
        sharedPreferences = App.getInstance().getSharedPreferences(App.getInstance().getString(R.string.app_name), Context.MODE_PRIVATE);
    }
